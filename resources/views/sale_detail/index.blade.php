        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('sale.store') }}" class="form-sale" method="post">
                            @csrf
...
<script>
    ...
    $(function () {
        ...
        table = $('.table-sale').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('sale_detail.data', $id_sales) }}',
            },
            columns: [
    ...
    function tambahProduk() {
        $.post('{{ route('sale_detail.store') }}', $('.form-produk').serialize())
            .done(response => {
                $('#code_product').focus();
                table.ajax.reload(() => loadForm($('#discount').val()));
            })
    ...
    function loadForm(diskon = 0) {
        ...
        $.get(`{{ url('/sale_detail/loadform') }}/${diskon}/${$('.total').text()}`)
            .done(response => {
